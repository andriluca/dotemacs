...
#+end_src
* MODELINE
Creo la mia modeline personale, con meno distrazioni e più leggibilità.
Informazioni da mantenere:
- Nome del Buffer che sto modificando
- Indicatore di modifica del Buffer
- Indicatore di "scrivibilità" del Buffer
- Data e ora
